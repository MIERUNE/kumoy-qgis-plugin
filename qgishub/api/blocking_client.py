...
class BlockingApiClient:
    """Blocking API client for use in feature iterators that uses QgsBlockingNetworkRequest"""
    ...
    def get(endpoint: str, params: Optional[Dict] = None) -> dict:
        ...
        if err != QgsBlockingNetworkRequest.NoError:
            ...
            return BlockingApiClient.handle_reply(QByteArray(), error_msg)
        
        reply = blocking_request.reply()
        return BlockingApiClient.handle_reply(reply.content(), "")
